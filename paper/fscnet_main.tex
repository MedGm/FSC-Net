...
The $\lambda$ investigation (Table~\ref{tab:consolidation_lambda}) used 10 seeds (42--51) for the initial study, with full results in \texttt{lambda\_zero\_investigation\_20251110\_194805.csv}, confirming $\lambda = 0.0$ (91.46\% $\pm$ 0.84\%) outperforms $\lambda = 0.5$ (90.20\% $\pm$ 1.67\%) by +1.26pp. The 30-seed Split-MNIST validation (seeds 42--71, Table~\ref{tab:mnist}) achieved slightly higher retention (91.71\% $\pm$ 0.62\%) with tighter variance.
